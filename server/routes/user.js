...
import { userRegistration ,userLogin ,forgotPassword ,resetPassword ,userLogout ,adminLogin , adminLogout ,verifyOtp ,getAllUsers ,getUserId ,updateProfile ,getCurrentUser ,uploadProfilePhoto ,deleteProfilePhoto ,changePassword ,getMyProfile ,verifyAccount ,verifyAccountOtp} from "../controllers/userController.js";
...
userRouter.post('/admin/logout',auth,adminLogout)
